...
# === for master
LOG_MOTES                         = {'type': 'motes',                     'keys':['motes']}
#LOG_TRACK_IDLE_RX                 = {'type': 'track.idle_rx',             'keys':['_mote_id', 'num_idle_rx, 'track_id']}
LOG_TRACK_IDLE_LISTEN_RX_TOTAL           = {'type': 'track.idle_listen_rx_total',       'keys':['_mote_id', 'trackId', 'num_idle_listen_rx']}
LOG_TRACK_RECEIVE_RX_TOTAL               = {'type': 'track.receive_rx_total',           'keys':['_mote_id', 'trackId', 'num_receive_rx']}
LOG_TRACK_DISABLED_RX_TOTAL              = {'type': 'track.disabled_rx_total',          'keys':['_mote_id', 'trackId', 'num_disabled_rx']}
LOG_TRACK_ELAPSED_RX_TOTAL               = {'type': 'track.elapsed_rx_total',           'keys':['_mote_id', 'trackId', 'num_elapsed_rx']}
