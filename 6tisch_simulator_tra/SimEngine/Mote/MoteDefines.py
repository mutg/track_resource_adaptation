...
PKT_TYPE_DATA_TRACKED_CRITICAL              = 'DATA_TRACKED_CRITICAL'
PKT_TYPE_DATA_TRACKED_BEFFORT               = 'DATA_TRACKED_BEST_EFFORT'

TRACKED_TYPES = [PKT_TYPE_DATA_TRACKED_CRITICAL, PKT_TYPE_DATA_TRACKED_BEFFORT, PKT_TYPE_DATA]
