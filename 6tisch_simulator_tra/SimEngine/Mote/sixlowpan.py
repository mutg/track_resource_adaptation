...
class Sixlowpan(object):
    ...
    def sendPacket(self, packet):
        ...
        assert packet['type'] in [
            ...
            d.PKT_TYPE_DAO,
            d.PKT_TYPE_DATA,
            d.PKT_TYPE_DATA_TRACKED_CRITICAL
        ]
    ...
    def recvPacket(self, packet):
        ...
        if goOn:
            if  (
                ...
                elif packet['type'] == d.PKT_TYPE_DATA or packet['type'] == d.PKT_TYPE_DATA_TRACKED_CRITICAL:
    ...
    def _find_nexthop_mac_addr(self, packet):
        ...
        # special magic for staying on dedicated route
        '''
        if packet['type'] == 'DATA':
