...
class RplOF0(object):
    ...
    def _update_preferred_parent(self):
        ...
        if self.rpl.mote.id == 1:
            new_parent = self._find_neighbor(self.rpl.engine.motes[0].get_mac_addr())
        elif self.rpl.mote.id == 2:
            new_parent = self._find_neighbor(self.rpl.engine.motes[1].get_mac_addr())
        elif self.rpl.mote.id == 3:
            new_parent = self._find_neighbor(self.rpl.engine.motes[2].get_mac_addr())
